...
import { CartMethods } from "../pages/login/cart/cart.methods";
...
describe(CommonPageData.testSuites.catalogoYCompras, ()=>{
    ...
    it("Agregar producto al carrito", () =>{
        ...
        Logger.stepNumber(7)
        Logger.verification('Verificar que se muestre un mensaje de comfirmación y el producto se agrega al carrito')
    ...
    it("Realizar una compra", () =>{
        ...
        Logger.stepNumber(7)
        Logger.verification('Verificar que se muestre un mensaje de confirmación y el producto se agrega al carrito')
        ProductDetailsMethods.verifyProductAddedMessage();
        CommonPageMethods.clickOnCartOption();
        CartMethods.verifyProductAdded(product);
        ...
        Logger.stepNumber(9)
        Logger.step('Verificar que se muestra la páginad del carrito de compras')
